Automated NixOS Configuration Modularization Script

I'll create a shell script that automatically sets up the modular directory structure and creates all the configuration files for you.
...
1. Save this script as modularize-nixos.sh in your /etc/nixos directory
2. Make it executable: chmod +x modularize-nixos.sh
3. Run it: sudo ./modularize-nixos.sh

What the script does:

1. Creates a backup of your current configuration
2. Sets up the modular directory structure
3. Creates all the configuration files with appropriate content
4. Provides instructions for next steps

Important notes:

· The script will backup your current configuration before making changes
· You should review the generated files to ensure they match your hardware and preferences
· You might need to adjust the GPU type in hardware/graphics.nix if needed
· After running the script, test with sudo nixos-rebuild dry-activate before applying

This script automates the process of converting your monolithic configuration into a modular one, making it easier to manage and maintain your NixOS system.
